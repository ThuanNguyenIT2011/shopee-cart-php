			...
			<div class="container">
				...
				<div class="col-md-6">
					<div class="box-content">
						...
						<?php 
						if(isset($_GET['message']) && $_GET['message']==1){ ?><div class="alert alert-danger" role="alert"><?php echo "Invalid Login Credentials"; ?></div><?php } ?>
				...
				<div class="col-md-6">
					<div class="box-content">
						...
						<div class="clearfix space40"></div>
						<?php if(isset($_GET['message']) && $_GET['message']==2){ ?><div class="alert alert-danger" role="alert"><?php echo "Faild to Register"; ?></div><?php } ?>
